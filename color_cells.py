...
#changes to original code by Mansi Sakarvadia

'''
frotrates how to assign colors to cells in a vtkPolyData structure using
 lookup tables.
...
if __name__ == '__main__':
    #No longer checking for VTK version
    iren = main()
    iren.Start()
